...
// node_modules/litepicker/dist/plugins/ranges.js
!function(e) {
  var n = {};
  function t(r) {
    if (n[r])
  ...
  t.m = e, t.c = n, t.d = function(e2, n2, r) {
  ...
  e.exports = function(e2) {
    ...
    return n2.toString = function() {
      return this.map(function(n3) {
        var t2 = function(e3, n4) {
          ...
          if (n4 && "function" == typeof btoa) {
            var a = (i = r, s = btoa(unescape(encodeURIComponent(JSON.stringify(i)))), c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(s), "/*# ".concat(c, " */")), o = r.sources.map(function(e4) {
              return "/*# sourceURL=".concat(r.sourceRoot || "").concat(e4, " */");
            });
            return [t3].concat(o).concat([a]).join("\n");
          }
          var i, s, c;
          return [t3].join("\n");
        }(n3, e2);
      ...
      for (var s = 0; s < e3.length; s++) {
        var c = [].concat(e3[s]);
        r && a[c[0]] || (t2 && (c[2] ? c[2] = "".concat(t2, " and ").concat(c[2]) : c[2] = t2), n2.push(c));
      }
    }, n2;
  };
}, function(e, n, t) {
  ...
  function s(e2, n2) {
    for (var t2 = [], r2 = {}, a2 = 0; a2 < e2.length; a2++) {
      var o2 = e2[a2], i2 = n2.base ? o2[0] + n2.base : o2[0], s2 = { css: o2[1], media: o2[2], sourceMap: o2[3] };
      r2[i2] ? r2[i2].parts.push(s2) : t2.push(r2[i2] = { id: i2, parts: [s2] });
    }
    return t2;
  }
  function c(e2, n2) {
    for (var t2 = 0; t2 < e2.length; t2++) {
      var r2 = e2[t2], o2 = a[r2.id], i2 = 0;
      if (o2) {
        for (o2.refs++; i2 < o2.parts.length; i2++)
          o2.parts[i2](r2.parts[i2]);
        for (; i2 < r2.parts.length; i2++)
          o2.parts.push(m(r2.parts[i2], n2));
      } else {
        for (var s2 = []; i2 < r2.parts.length; i2++)
          s2.push(m(r2.parts[i2], n2));
  ...
  function l(e2) {
    ...
    if (void 0 === e2.attributes.nonce) {
      var r2 = t.nc;
      r2 && (e2.attributes.nonce = r2);
    }
    if (Object.keys(e2.attributes).forEach(function(t2) {
      n2.setAttribute(t2, e2.attributes[t2]);
  ...
  function p(e2, n2, t2, r2) {
    var a2 = t2 ? "" : r2.css;
    if (e2.styleSheet)
      e2.styleSheet.cssText = d(n2, a2);
    else {
      var o2 = document.createTextNode(a2), i2 = e2.childNodes;
      i2[n2] && e2.removeChild(i2[n2]), i2.length ? e2.insertBefore(o2, i2[n2]) : e2.appendChild(o2);
    }
  }
  function f(e2, n2, t2) {
    var r2 = t2.css, a2 = t2.media, o2 = t2.sourceMap;
    if (a2 && e2.setAttribute("media", a2), o2 && btoa && (r2 += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(o2)))), " */")), e2.styleSheet)
  ...
  function m(e2, n2) {
    ...
    if (n2.singleton) {
      var o2 = b++;
      t2 = g || (g = l(n2)), r2 = p.bind(null, t2, o2, false), a2 = p.bind(null, t2, o2, true);
    } else
      t2 = l(n2), r2 = f.bind(null, t2, n2), a2 = function() {
        !function(e3) {
  ...
  e.exports = function(e2, n2) {
    (n2 = n2 || {}).attributes = "object" == typeof n2.attributes ? n2.attributes : {}, n2.singleton || "boolean" == typeof n2.singleton || (n2.singleton = o());
    var t2 = s(e2, n2);
    return c(t2, n2), function(e3) {
      for (var r2 = [], o2 = 0; o2 < t2.length; o2++) {
        var i2 = t2[o2], l2 = a[i2.id];
        l2 && (l2.refs--, r2.push(l2));
      }
      e3 && c(s(e3, n2), n2);
  ...
  Litepicker.add("ranges", { init: function(e2) {
    var n2 = { position: "left", customRanges: {}, customRangesLabels: ["Today", "Yesterday", "Last 7 Days", "Last 30 Days", "This Month", "Last Month"], force: false, autoApply: e2.options.autoApply };
    e2.options.ranges = a(a({}, n2), e2.options.ranges), e2.options.singleMode = false;
    var t2 = e2.options.ranges;
    if (!Object.keys(t2.customRanges).length) {
      var r2, i = e2.DateTime();
      t2.customRanges = (o(r2 = {}, t2.customRangesLabels[0], [i.clone(), i.clone()]), o(r2, t2.customRangesLabels[1], [i.clone().subtract(1, "day"), i.clone().subtract(1, "day")]), o(r2, t2.customRangesLabels[2], [i.clone().subtract(6, "day"), i]), o(r2, t2.customRangesLabels[3], [i.clone().subtract(29, "day"), i]), o(r2, t2.customRangesLabels[4], function(e3) {
        var n3 = e3.clone();
        return n3.setDate(1), [n3, new Date(e3.getFullYear(), e3.getMonth() + 1, 0)];
      }(i)), o(r2, t2.customRangesLabels[5], function(e3) {
        var n3 = e3.clone();
        return n3.setDate(1), n3.setMonth(e3.getMonth() - 1), [n3, new Date(e3.getFullYear(), e3.getMonth(), 0)];
      }(i)), r2);
    }
    e2.on("render", function(n3) {
      var r3 = document.createElement("div");
      r3.className = "container__predefined-ranges", e2.ui.dataset.rangesPosition = t2.position, Object.keys(t2.customRanges).forEach(function(a2) {
        var o2 = t2.customRanges[a2], i2 = document.createElement("button");
        i2.innerText = a2, i2.tabIndex = n3.dataset.plugins.indexOf("keyboardnav") >= 0 ? 1 : -1, i2.dataset.start = o2[0].getTime(), i2.dataset.end = o2[1].getTime(), i2.addEventListener("click", function(n4) {
          var r4 = n4.target;
          if (r4) {
            var a3 = e2.DateTime(Number(r4.dataset.start)), o3 = e2.DateTime(Number(r4.dataset.end));
            t2.autoApply ? (e2.setDateRange(a3, o3, t2.force), e2.emit("ranges.selected", a3, o3), e2.hide()) : (e2.datePicked = [a3, o3], e2.emit("ranges.preselect", a3, o3)), !e2.options.inlineMode && t2.autoApply || e2.gotoDate(a3);
          }
        }), r3.appendChild(i2);
      }), n3.querySelector(".container__main").prepend(r3);
    });
  } });
}, function(e, n, t) {
  var r = t(10);
  "string" == typeof r && (r = [[e.i, r, ""]]);
  var a = { insert: function(e2) {
    var n2 = document.querySelector("head"), t2 = window._lastElementInsertedByStyleLoader;
    window.disableLitepickerStyles || (t2 ? t2.nextSibling ? n2.insertBefore(e2, t2.nextSibling) : n2.appendChild(e2) : n2.insertBefore(e2, n2.firstChild), window._lastElementInsertedByStyleLoader = e2);
  }, singleton: false };
  t(1)(r, a);
  r.locals && (e.exports = r.locals);
}, function(e, n, t) {
  (n = t(0)(false)).push([e.i, '.litepicker[data-plugins*="ranges"] > .container__main > .container__predefined-ranges {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  background: var(--litepicker-container-months-color-bg);\n  box-shadow: -2px 0px 5px var(--litepicker-footer-box-shadow-color);\n  border-radius: 3px;\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="left"] > .container__main {\n  /* */\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="right"] > .container__main{\n  flex-direction: row-reverse;\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="right"] > .container__main > .container__predefined-ranges {\n  box-shadow: 2px 0px 2px var(--litepicker-footer-box-shadow-color);\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="top"] > .container__main {\n  flex-direction: column;\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="top"] > .container__main > .container__predefined-ranges {\n  flex-direction: row;\n  box-shadow: 2px 0px 2px var(--litepicker-footer-box-shadow-color);\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="bottom"] > .container__main {\n  flex-direction: column-reverse;\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="bottom"] > .container__main > .container__predefined-ranges {\n  flex-direction: row;\n  box-shadow: 2px 0px 2px var(--litepicker-footer-box-shadow-color);\n}\n.litepicker[data-plugins*="ranges"] > .container__main > .container__predefined-ranges button {\n  padding: 5px;\n  margin: 2px 0;\n}\n.litepicker[data-plugins*="ranges"][data-ranges-position="left"] > .container__main > .container__predefined-ranges button,\n.litepicker[data-plugins*="ranges"][data-ranges-position="right"] > .container__main > .container__predefined-ranges button{\n  width: 100%;\n  text-align: left;\n}\n.litepicker[data-plugins*="ranges"] > .container__main > .container__predefined-ranges button:hover {\n  cursor: default;\n  opacity: .6;\n}', ""]), e.exports = n;
}]);

// Scripts/components.ts
function createDateRangePicker(element, dotNetRef, startDate, endDate, minDate, maxDate, minYear, maxYear) {
  try {
    const picker = new import_litepicker.default({
      element,
    ...
    picker.on(
      "selected",
      async (startDate2, endDate2) => {
        await dotNetRef.invokeMethodAsync(
          "JsDateRangeSelected",
          startDate2.toDateString(),
          endDate2.toDateString()
        );
      }
    );
    return picker;
...
litepicker/dist/plugins/ranges.js:
  (*!
   * 
   * plugins/ranges.js
   * Litepicker v2.0.12 (https://github.com/wakirin/Litepicker)
